...
```sh
.claude/knowledge/reference/operations/scripts/bastion-tunnel.sh qa          # default local port: 5433
.claude/knowledge/reference/operations/scripts/bastion-tunnel.sh qa 5433     # custom local port
```
...
```sh
.claude/knowledge/reference/operations/scripts/ecs-exec.sh qa                # /bin/sh in web-platform container
.claude/knowledge/reference/operations/scripts/ecs-exec.sh dev qbrick        # other container in the task
```
...
```sh
.claude/knowledge/reference/operations/scripts/db-migrate.sh qa
```
...
```sh
.claude/knowledge/reference/operations/scripts/db-seed.sh qa
```
...
.claude/knowledge/reference/operations/scripts/get-secret.sh mmbr-qa-web-platform

# Single key
.claude/knowledge/reference/operations/scripts/get-secret.sh mmbr-qa-web-platform DB_HOST
.claude/knowledge/reference/operations/scripts/get-secret.sh mmbr-prod-backend-ui NEXTAUTH_SECRET
```
...
echo '{"AUTH0_BASE_URL":"https://mem-brain.com"}' \
  | .claude/knowledge/reference/operations/scripts/set-secret-keys.sh mmbr-prod-web-platform

# From a file
.claude/knowledge/reference/operations/scripts/set-secret-keys.sh mmbr-prod-web-platform < additions.json
```
