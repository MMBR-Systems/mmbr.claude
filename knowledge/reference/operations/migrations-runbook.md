...
.claude/knowledge/reference/operations/scripts/bastion-tunnel.sh qa
.claude/knowledge/reference/operations/scripts/bastion-tunnel.sh prod
```
...
```sh
.claude/knowledge/reference/operations/scripts/get-secret.sh mmbr-dev-web-platform DATABASE_USER
.claude/knowledge/reference/operations/scripts/get-secret.sh mmbr-dev-web-platform DATABASE_PASSWORD
.claude/knowledge/reference/operations/scripts/get-secret.sh mmbr-dev-web-platform DATABASE_NAME
```
