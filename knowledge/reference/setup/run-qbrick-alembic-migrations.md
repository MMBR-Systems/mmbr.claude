...
- `mmbr-dev-qbrick.DATABASE_URI` must point at the real RDS proxy (not docker-compose defaults). See `.claude/knowledge/known-issues/qbrick-dev-secret-template-defaults.md`.
