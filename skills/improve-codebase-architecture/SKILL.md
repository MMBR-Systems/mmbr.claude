...
Once the user picks a candidate, drop into a grilling conversation (see the `grill-me` skill). Walk the design tree with them — constraints, dependencies, the shape of the deepened module, what sits behind the seam, what tests survive.
